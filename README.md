...
**05. JASON - JavaScript Object Notation**

- Файлов формат с отворен стандарт, който използва текст за предаване на обекти от данни.
- JASON е самоописващ се и лесен за разбиране, той може да бъде използван в различни програмни езици и е независим от конкретния език за програмиране.

**06. JSON Usage**

- JASON се използва за обмен на данни между браузъра и сървара. Той е по-лек формат в сравнение с XML.
- JavaScript има вградени функции за анализиране на JASON, така, че е лесен за използване.
```
{
"name": "Ivan",
"age": 25,
